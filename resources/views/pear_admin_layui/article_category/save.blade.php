...
@section('content')
    <form class="layui-form" action="">
        ...
        @include('component.text', ['label' => '分类名', 'name' => 'name', 'value' => $article_category['name'], 'verify' => 'required', 'block' => 1])

        @include('component.text', ['label' => '编码', 'name' => 'code', 'value' => $article_category['code'], 'verify' => 'required', 'block' => 1])
        ...
        @include('component.text', ['label' => '排序', 'name' => 'sort', 'value' => $article_category['sort'], 'block' => 1])
